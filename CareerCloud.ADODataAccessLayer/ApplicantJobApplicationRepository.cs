    ...
    public class ApplicantJobApplicationRepository : IDataRepository<ApplicantJobApplicationPoco>
    {
        ...
        public IList<ApplicantJobApplicationPoco> GetAll(params Expression<Func<ApplicantJobApplicationPoco, object>>[] navigationProperties)
        {
            using (SqlConnection connection = new SqlConnection(_connectionStr))
            {
                ...
                {
                    Connection = connection,
                    CommandText = @"SELECT [Id],[Applicant],[Job],[Application_Date],[Time_Stamp]
                ...
                while (readpointer.Read())
                {
                    ...
                    {
                        Id = readpointer.GetGuid(0),
                        Applicant = readpointer.GetGuid(1),
                        Job = readpointer.GetGuid(2),
                        ApplicationDate = readpointer.GetDateTime(3),
                        TimeStamp = (byte[])readpointer[4]
                    };
